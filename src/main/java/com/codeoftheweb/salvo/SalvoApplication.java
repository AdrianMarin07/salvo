...
public class SalvoApplication {
	...
	public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository, GamePlayerRepository gamePlayerRepository, ShipRepository shipRepository, SalvoRepository salvoRepository, ScoreRepository scoreRepository) {
		return (args) -> {
			...
			Player player1 = new Player("jblack@gmail.com", passwordEncoder.encode("1234"));
			Player player2 = new Player("mpower@gmail.com", passwordEncoder.encode("007"));
			Player player3 = new Player("jbatman@gmail.com", passwordEncoder.encode("robin"));
			...
			Score score1 = new Score(Date.from(creationDate.toInstant()), player1, game1, 1);
			Score score2 = new Score(Date.from(creationDate.toInstant()), player1, game3, 0);
			Score score3 = new Score(Date.from(creationDate.toInstant()), player2, game1, 0);
			Score score4 = new Score(Date.from(creationDate.toInstant()), player2, game2, 1);
			Score score5 = new Score(Date.from(creationDate.toInstant()), player3, game2, 0);
			Score score6 = new Score(Date.from(creationDate.toInstant()), player3, game3, 1);
...
class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.exceptionHandling().authenticationEntryPoint((req, res, exc) -> res.sendError(HttpServletResponse.SC_BAD_REQUEST));
